...
const CALC_TYPE_OPTIONS = [
  { key: 'solar',      icon: 'sun',        label: 'СЕС',      hint: 'Генерація та продаж або самоспоживання' },
  { key: 'bess',       icon: 'battery',    label: 'УЗЕ',      hint: 'Арбітраж та аРВЧ' },
  { key: 'solar_bess', icon: 'solar-bess', label: 'СЕС + УЗЕ', hint: 'Комбінована система' },
];
        ...
        <div className="card">
          ...
          <div className="calc-type-switcher">
            {CALC_TYPE_OPTIONS.map((opt) => (
              ...
              >
                <span className="calc-type-icon"><Icon name={opt.icon} /></span>
